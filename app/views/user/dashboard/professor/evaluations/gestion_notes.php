...
<div class="container mt-4">
    <!-- Breadcrumb similaire à edit.php -->
    <div class="row mb-4">
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <i class="fas fa-pen"></i> Gestion des notes
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card">
        <div class="card-header">
            <h1 class="h3 mb-0">Gestion des notes - <?= $this->e($matiere->getNom()) ?></h1>
        </div>
        <div class="card-body">
            ...
            <form method="POST" action="<?= $this->url('professor.matieres.evaluations.notes', [
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" 
                                               ...
                                               value="<?= $note ? $note->getCommentaire() : '' ?>"
                                               maxlength="255">
                                    </td>
                                </tr>
                            <?php endforeach; ?>
